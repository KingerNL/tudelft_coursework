...
variable modify  &
   ...
   string_value = "TNO_car205_60R15_ride.tir"
!
variable modify  &
...
!
simulation set file_prefix="Full_tpf"
simulation single_run scripted  sim_script_name = .model_1.SIM_SCRIPT_1 reset_before_and_after = yes
! rename analysis
   entity modify entity = .model_1.Last_Run new = .model_1.Full_tpf
!
variable modify variable_name = .model_1.tyre_left.wheel_tire_mass real_value = (2+3.260)
variable modify variable_name = .model_1.tyre_left.Izz real_value = 0.6382
variable modify variable_name = .model_1.Oy real_value = 36.2296
variable modify variable_name = .model_1.hcg real_value = 0.2944
!
simulation set file_prefix="Reduced_tpf"
variable modify variable_name = .model_1.tyre_left.property_file string_value = "TNO_car205_60R15_ride_reduced_input.tir"
simulation single_run scripted  sim_script_name = .model_1.SIM_SCRIPT_1 reset_before_and_after = yes
! rename analysis
   entity modify entity = .model_1.Last_Run new = .model_1.Reduced_tpf