...
variable create  &
   ...
   real_value = (116*PI/180)
!
variable create  &
   variable_name = .model_1.tswd0  &
   real_value = 3
!
variable create  &
   variable_name = .model_1.dwell  &
   real_value = 0.5
!
variable create  &
   variable_name = .model_1.fswd  &
   real_value = 0.7
!
variable create  &
   variable_name = .model_1.is  &
   real_value = 16
!
variable create  &
   variable_name = .model_1.Aswd  &
   real_value = (1/is*STEER)
!
variable create  &
...
constraint modify motion_generator  &
   motion_name = .model_1.MOT_left  &
   function = "(IF(time-tswd0 : 0 , 0 , Aswd*sin(2*PI*fswd*(time-tswd0)) + IF(time-(tswd0+3/4*1/fswd) : 0 , 0 , -Aswd*sin(2*PI*fswd*(time-tswd0)) + IF(time-(tswd0+3/4*1/fswd+dwell) : -Aswd , -Aswd , Aswd*sin(2*PI*fswd*(time-tswd0-dwell)) + IF(time-(tswd0+1/fswd+dwell) : 0 , 0 , -Aswd*sin(2*PI*fswd*(time-tswd0-dwell))) ))) )"
!
constraint modify motion_generator  &
   motion_name = .model_1.MOT_right  &
   function = "(IF(time-tswd0 : 0 , 0 , Aswd*sin(2*PI*fswd*(time-tswd0)) + IF(time-(tswd0+3/4*1/fswd) : 0 , 0 , -Aswd*sin(2*PI*fswd*(time-tswd0)) + IF(time-(tswd0+3/4*1/fswd+dwell) : -Aswd , -Aswd , Aswd*sin(2*PI*fswd*(time-tswd0-dwell)) + IF(time-(tswd0+1/fswd+dwell) : 0 , 0 , -Aswd*sin(2*PI*fswd*(time-tswd0-dwell))) ))) )"
