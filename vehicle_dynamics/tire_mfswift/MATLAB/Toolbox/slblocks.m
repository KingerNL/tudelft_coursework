...
%
blkStruct.Name = ['TNO Delft-Tyre'];
%
% The function that will be called when the user double-clicks on
% this icon.
%
blkStruct.OpenFcn = 'Delft_Tyre_root_lib';
...
%
blkStruct.MaskDisplay = 'TNO Delft-Tyre';
...
%
Browser(1).Library = 'Delft_Tyre_root_lib';
Browser(1).Name    = 'TNO Delft-Tyre';
